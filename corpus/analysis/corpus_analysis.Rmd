...
(TOP (S (NP-SBJ (PRP I)) 
        (VP (VBD thought) (, ,) 
            (SBARQ-SEZ (INTJ (UH well)) 
                        (, ,) 
                        (EDITED (RM (-DFL- \[)) 
                        (SBARQ (WHADVP (WRB how)) 
                                (SQ-UNF (VBP do) (NP-SBJ (PRP you)))) (, ,) (IP (-DFL- \+))) (WHADVP-1 (WRB how)) (SQ (VBP do) (NP-SBJ (PRP you)) (RS (-DFL- \])) (VP (VB weed) (NP (DT those)) (PRT (RP out)) (ADVP-MNR (-NONE- *T*-1)))))) (. ?) (-DFL- E_S)))
