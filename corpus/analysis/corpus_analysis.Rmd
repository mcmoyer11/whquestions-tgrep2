...
set.seed(234)
se <- sample(d_emb,30)
View(se[se[,c("Sentence","Item_ID","SentenceParse","MatrixPred1","InvertedMatrixVerb")]])
...
1064:40
(TOP (S (NP-SBJ (NP (NN Loneliness)) (SBAR (-NONE- *ICH*-2))) 
        (VP (VBZ is) (NP-PRD (NP (DT the) (RBS closest)) 
                              (SBAR (WHADJP-1 (-NONE- 0)) (S (NP-SBJ (PRP you)) 
                                                            (VP (MD can) (VP (VB come) (ADJP-PRD (-NONE- *T*-1))))))) 
                      (, ,) 
                      (SBAR-2 (WHNP-3 (WDT which)) (S (NP-SBJ (-NONE- *T*-3)) (VP (VBZ is) (ADVP (RB really)) (ADJP-PRD (RB quite) (JJ different)))))) (. .) (-DFL- E_S)))


(TOP (SQ (VBZ Is) (NP-SBJ (DT that)) 
